  ...
  return (
    <div className="flex-1 w-full max-w-4xl mx-auto px-4 py-12 md:py-16 overflow-y-auto">
      ...
      <div className="mb-10">
        ...
        <p className="mt-4 text-zinc-600 dark:text-zinc-400 text-base max-w-2xl">
      ...
      <div className="grid grid-cols-1 gap-6">
        {BLOG_POSTS.map((post) => (
          <Link href={`/blog/${post.slug}`} key={post.slug} className="group flex flex-col p-6 bg-zinc-50 dark:bg-[#121215] border border-zinc-200 dark:border-[#27272A] rounded-xl hover:bg-zinc-100 dark:hover:bg-[#18181B] transition-all duration-200">
            <h2 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100 group-hover:text-blue-500 transition-colors mb-2">
              {post.title}
            </h2>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-4 line-clamp-2">
              {post.description}
            </p>
            <div className="flex items-center justify-between mt-auto pt-4 border-t border-zinc-200 dark:border-[#27272A]/50">
