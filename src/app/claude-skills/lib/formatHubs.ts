...
export const FORMAT_HUBS: Record<string, FormatHubMeta> = {
  "cursor-rules": {
    ...
    seoTitle: "Cursor Rules (.mdc) Generator & Directory | Free Offline AI Tools",
...
- Always use typed Zod schemas for input validation.`
  ...
  "claude-skills": {
    ...
    seoTitle: "Claude Code Skills (SKILL.md) Directory & Generator | Free & Offline",
...
3. Categorize findings into CRITICAL, HIGH, and MEDIUM.`
  ...
  "claude-md": {
    ...
    seoTitle: "CLAUDE.md Guide & Generator for Anthropic Claude Code",
...
- Styling: Tailwind CSS v4 utility classes only.`
  ...
  "agents-md": {
    ...
    targetDir: "./ (Repository Root)",
    seoTitle: "AGENTS.md Generator & Specification | Multi-Agent Coding Standards",
...
3. No newly introduced TypeScript errors`
  ...
  "mcp-config": {
    ...
    seoTitle: "Model Context Protocol (MCP) Config Directory & Generator",
