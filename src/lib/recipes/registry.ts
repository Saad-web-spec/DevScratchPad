...
export const RECIPE_REGISTRY: Record<string, RecipeMeta> = {
  "typeerror-cannot-read-properties-of-undefined-reading-map": {
    ...
    "faq": [
      {
        "question": "Why does map() crash on API data?",
        "answer": "The API returned undefined or an object instead of an array, usually because the endpoint changed or the fetch failed silently."
      },
      {
        "question": "How do I automatically type JSON?",
        "answer": "Use our JSON to TypeScript converter. Paste your JSON payload and get ready-to-use TypeScript interfaces."
      }
    ]
  },
    ...
    "faq": [
      {
        ...
        "answer": "It means the hash of the payload and header does not match the signature provided, usually due to a wrong secret key."
      },
      {
        "question": "Can I decode a token without the secret?",
        "answer": "Yes! The header and payload of a JWT are just Base64Url encoded. You can view them using our JWT Decoder tool."
      }
    ]
  },
  "curl-52-empty-reply-from-server": {
    ...
    "faq": [
      {
        "question": "Why does the server drop the connection?",
        "answer": "Common reasons include SSL/TLS mismatch, firewall blocking, or the server crashing while processing the request."
      },
      {
        "question": "How can I easily convert curl to Python?",
        "answer": "Use our cURL to Python tool to instantly generate valid requests code from any curl command."
      }
    ]
  },
  "unexpected-token-o-in-json-at-position-1": {
    ...
    "faq": [
      {
        "question": "Why does it say position 1?",
        "answer": "Because it converts the object to the string \"[object Object]\". The first character is \"[\", the second (position 1) is \"o\". JSON expects quotes."
      },
      {
        "question": "How can I validate my JSON string?",
        "answer": "Use our JSON Formatter to paste your string and ensure it is valid JSON before parsing."
      }
    ]
  },
    ...
    "faq": [
      {
        ...
        "answer": "No, the YAML specification forbids tabs for indentation. Always use spaces."
      },
      {
        "question": "How do I debug complex YAML?",
        "answer": "Convert it to JSON using our YAML to JSON converter. JSON is stricter and tooling will immediately flag structural issues."
      }
    ]
  },
  "cron-not-running-at-expected-time": {
    ...
    "faq": [
      {
        "question": "Does cron respect my server time zone?",
        "answer": "Yes, cron uses the system time zone by default. If your server is UTC, a job scheduled for 12:00 will run at 12:00 UTC."
      },
      {
        "question": "How can I test my cron expression?",
        "answer": "Use our Cron Schedule Visualizer to generate a human-readable list of the next 10 execution times."
      }
    ]
  },
  "zoderror-invalid-type-expected-string-received-number": {
    ...
    "faq": [
      {
        "question": "Why use Zod over TypeScript interfaces?",
        "answer": "TypeScript interfaces are stripped out at compile time. Zod validates data at runtime, preventing bad data from entering your app."
      },
      {
        "question": "How do I create a Zod schema from a large JSON?",
        "answer": "Use our JSON to Zod Schema tool to instantly generate complete, nested validation schemas from any JSON payload."
      }
    ]
  },
  "curl-3-url-using-bad-slash": {
    ...
    "faq": [
      {
        "question": "Why do single quotes fail in Windows curl?",
        "answer": "Windows Command Prompt (cmd.exe) does not treat single quotes as string delimiters. You must use double quotes and escape internal quotes."
      },
      {
        "question": "How can I convert complex curl commands to fetch?",
        "answer": "Use our cURL to Fetch tool to automatically generate the equivalent JavaScript code."
      }
    ]
  },
  "invalid-dom-property-class-did-you-mean-classname": {
    ...
    "faq": [
      {
        "question": "Do I have to rename every property manually?",
        "answer": "No, you can automate this. Using an SVG to JSX converter handles all camelCasing and tag closures for you."
      },
      {
        "question": "Why does React enforce camelCase?",
        "answer": "React normalizes DOM attributes to match the standard JavaScript DOM API, which uses camelCase (like `element.className`)."
      }
    ]
  },
  "hmac-signature-does-not-match": {
    ...
    "faq": [
      {
        "question": "What is req.rawBody?",
        "answer": "In frameworks like Express, you must configure the body-parser to save the raw buffer before it converts it to a JavaScript object."
      },
      {
        "question": "How can I test my secret key?",
        "answer": "Use our HMAC Generator to manually hash your raw JSON payload with your secret and compare it to the header."
      }
    ]
  },
  "json-schema-data-must-not-have-additional-properties": {
    ...
    "faq": [
      {
        "question": "Is additionalProperties: false secure?",
        "answer": "Yes, it ensures your application only processes expected data and prevents over-posting attacks."
      },
      {
        "question": "How do I test this schema?",
        "answer": "Use our JSON Schema Validator to instantly check if your JSON data violates this property."
      }
    ]
  },
  "json-schema-data-must-be-array": {
    ...
    "faq": [
      {
        "question": "Can a schema accept both object and array?",
        "answer": "Yes, use `type: [\"object\", \"array\"]` or `oneOf` to support both structures."
      },
      {
        "question": "How can I fix the JSON?",
        "answer": "Use our JSON Formatter and Schema Validator to preview your changes in real time."
      }
    ]
  },
  "xml-entityref-expecting-semicolon": {
    ...
    "faq": [
      {
        ...
        "answer": "CDATA sections tell the XML parser to treat the content as raw text and ignore special characters like < and &."
      },
      {
        "question": "How do I format complex XML?",
        "answer": "Use our XML Formatter to indent and validate your documents."
      }
    ]
  },
  "sql-syntax-error-at-or-near": {
    ...
    "faq": [
      {
        "question": "Does every SQL dialect require semicolons?",
        "answer": "Most do for multiple statements (e.g., PostgreSQL, MySQL). Some client tools auto-append them, but scripts require them."
      },
      {
        "question": "How can I quickly spot these errors?",
        "answer": "Paste your code into our SQL Formatter to auto-indent and easily spot missing delimiters."
      }
    ]
  },
  "graphql-syntax-error-expected-name-found-eof": {
    ...
    "faq": [
      {
        ...
        "answer": "End Of File. The parser reached the end of your query string while it was still expecting more fields or braces."
      },
      {
        "question": "How can I automatically fix braces?",
        "answer": "Use our GraphQL Formatter, which relies on Prettier to automatically align and close selection sets."
      }
    ]
  },
  "css-minification-unexpected-token": {
    ...
    "faq": [
      {
        "question": "Why does it work in the browser but fail minification?",
        "answer": "Browsers are very forgiving and ignore broken CSS rules, but minifiers parse the AST strictly and will crash on invalid syntax."
      },
      {
        "question": "How can I minify safely?",
        "answer": "Use our CSS/SVG/HTML Minifier tool to test your code compression."
      }
    ]
  },
  "maximum-call-stack-size-exceeded": {
    ...
    "faq": [
      {
        "question": "What is the maximum call stack size?",
        "answer": "It varies by engine, but usually around 10,000 frames. Exceeding it means you have an infinite loop."
      },
      {
        "question": "How do I safely generate relational data?",
        "answer": "Use our Mock Data Generator which safely handles relational IDs without deep object nesting."
      }
    ]
  },
  "duplicate-key-value-violates-unique-constraint": {
    ...
    "faq": [
      {
        "question": "Can UUIDv4 collide?",
        "answer": "The probability of a collision is practically zero. You would need to generate 1 billion UUIDs per second for 85 years to reach a 50% chance of collision."
      },
      {
        "question": "How do I generate thousands of UUIDs?",
        "answer": "Use our UUID / ULID Generator to create bulk IDs instantly."
      }
    ]
  },
  "domexception-string-not-correctly-encoded": {
    ...
    "faq": [
      {
        "question": "Why does Node.js buffer not crash on this?",
        "answer": "Node.js Buffer.from(str, \"base64\") is more forgiving than the browser's strict atob() implementation."
      },
      {
        "question": "How can I inspect malformed base64?",
        "answer": "Use our Base64 Inspector which automatically handles padding and URL-safe conversions."
      }
    ]
  },
  "invalid-character-in-base64-string": {
    ...
    "faq": [
      {
        "question": "Should Base64 have line breaks?",
        "answer": "PEM certificates require 64-character line breaks, but standard Base64 parsing usually expects a continuous string."
      },
      {
        "question": "Can I decode it manually?",
        "answer": "Paste it into our Base64 Inspector and we will clean and decode it for you."
      }
    ]
  },
  "crypto-createhash-not-a-function": {
    ...
    "faq": [
      {
        "question": "Does WebCrypto support MD5?",
        "answer": "No, modern browsers removed MD5 from WebCrypto due to vulnerabilities. You must use a third-party library for client-side MD5."
      },
      {
        "question": "How can I hash data securely without code?",
        "answer": "Use our Hash Generator to calculate MD5, SHA256, and SHA512 simultaneously in the browser."
      }
    ]
  },
  "typeerror-data-must-be-string-or-buffer": {
    ...
    "faq": [
      {
        "question": "Will JSON.stringify produce the same hash every time?",
        "answer": "Only if the key order is strictly identical. For deterministic hashing of objects, use a library like json-stable-stringify."
      },
      {
        "question": "Where can I quickly test hashes?",
        "answer": "Our Hash Generator allows you to paste raw text and get instant cryptographic outputs."
      }
    ]
  },
  "bcrypt-comparesync-returns-false": {
    ...
    "faq": [
      {
        "question": "What is the 72-byte limit?",
        "answer": "The bcrypt algorithm only uses the first 72 bytes of the password. Any characters after that are ignored."
      },
      {
        "question": "How can I manually check a hash?",
        "answer": "Use our Password Hash & Verifier tool to test candidate passwords against existing bcrypt hashes."
      }
    ]
  },
  "unable-to-get-local-issuer-certificate": {
    ...
    "faq": [
      {
        "question": "Why does this work in Chrome but fail in Node?",
        "answer": "Browsers dynamically fetch missing intermediate certificates (AIA fetching) and have larger trust stores. Node.js is strict and only trusts bundled CAs."
      },
      {
        "question": "How do I inspect my certificate chain?",
        "answer": "Use our X.509 Certificate Decoder to inspect your server's PEM files."
      }
    ]
  },
  "permission-denied-publickey": {
    ...
    "faq": [
      {
        "question": "Which SSH key type is best?",
        "answer": "Ed25519 is the modern standard. It is faster and more secure than RSA."
      },
      {
        "question": "I need a new key pair urgently.",
        "answer": "Generate a secure Ed25519 key instantly in your browser using our SSH Key Generator."
      }
    ]
  },
  "cannot-unmarshal-string-into-go-struct": {
    ...
    "faq": [
      {
        "question": "What if the JSON field is sometimes a number and sometimes a string?",
        "answer": "The ,string tag only works if the JSON value is ALWAYS a string. For mixed types, unmarshal into an interface{} or a custom UnmarshalJSON type."
      },
      {
        "question": "How can I generate structs automatically?",
        "answer": "Use our JSON to Go Struct tool to generate accurate structs with tags from your payloads."
      }
    ]
  },
  "net-http-request-canceled": {
    ...
    "faq": [
      {
        "question": "Should I use the default http.DefaultClient?",
        "answer": "No! The default client has NO timeout, meaning a slow server can hang your Go application forever."
      },
      {
        "question": "How do I quickly write Go HTTP requests?",
        "answer": "Convert curl commands to Go instantly with our cURL to Go tool."
      }
    ]
  },
  "invalid-date-in-javascript": {
    ...
    "faq": [
      {
        "question": "Why does Safari return Invalid Date but Chrome works?",
        "answer": "Safari strictly requires ISO formats (like using \"T\" and \"Z\") whereas Chrome aggressively tries to parse irregular formats like \"2023-01-01 12:00:00\"."
      },
      {
        "question": "How can I convert epochs manually?",
        "answer": "Use our Epoch Converter to safely translate seconds and milliseconds to human time."
      }
    ]
  },
  "epoch-time-out-of-range": {
    ...
    "faq": [
      {
        "question": "Where do nanosecond epochs come from?",
        "answer": "Languages like Go (time.Now().UnixNano()) and some database systems emit timestamps in nanoseconds for high precision."
      },
      {
        "question": "How do I debug these huge numbers?",
        "answer": "Our Epoch Converter automatically detects seconds vs milliseconds to help prevent these mistakes."
      }
    ]
  },
  "syntaxerror-invalid-regular-expression": {
    ...
    "faq": [
      {
        "question": "Why does literal syntax /pattern/ not crash?",
        "answer": "Literal syntax is validated at compile time by the JavaScript engine. new RegExp() compiles at runtime based on string values."
      },
      {
        "question": "How can I test complex regex safely?",
        "answer": "Use our Regex Tester to validate patterns and groups in real time."
      }
    ]
  },
  "git-merge-conflict-markers-found": {
    ...
    "faq": [
      {
        "question": "Can I undo a messy merge?",
        "answer": "Yes, run `git merge --abort` in your terminal to cancel the merge and return to your previous state."
      },
      {
        "question": "How do I compare the two versions clearly?",
        "answer": "Paste both versions into our Diff Checker to view a side-by-side comparison of the changes."
      }
    ]
  },
  "invalid-cidr-notation": {
    ...
    "faq": [
      {
        "question": "What does the /24 mean?",
        "answer": "It means the first 24 bits of the IP address are fixed (the network), leaving 8 bits (256 addresses) for hosts."
      },
      {
        "question": "How do I calculate the correct base IP?",
        "answer": "Use our CIDR Calculator to instantly determine the network address, broadcast address, and valid host ranges."
      }
    ]
  },
  "expected-double-quoted-property-name": {
    ...
    "faq": [
      {
        "question": "Why does JSON strictly require double quotes?",
        "answer": "The JSON spec (RFC 8259) enforces double quotes to make parsing simpler and identical across dozens of programming languages."
      },
      {
        "question": "Can I auto-fix this?",
        "answer": "Yes! Paste your malformed JS object into our JSON Formatter and it will automatically quote keys and fix trailing commas."
      }
    ]
  },
  "yaml-did-not-find-expected-key": {
    ...
    "faq": [
      {
        "question": "Can I use a linter for this?",
        "answer": "Yes, setting up a YAML linter in your IDE is highly recommended."
      },
      {
        "question": "How do I fix large YAML files quickly?",
        "answer": "Paste it into our YAML to JSON converter. The error output will pinpoint the exact line number of the indentation failure."
      }
    ]
  },
  "token-expired-error-jwt": {
    ...
    "faq": [
      {
        "question": "Why not make JWTs last forever?",
        "answer": "Security. If a JWT is stolen, the attacker has access forever. Short-lived JWTs (e.g., 15 mins) minimize this risk."
      },
      {
        "question": "How can I check when my token expires?",
        "answer": "Paste your token into our JWT Decoder to view the exact expiration date in your local time zone."
      }
    ]
  },
  "cron-expression-6-parts-expected-5": {
    ...
    "faq": [
      {
        "question": "Does GitHub Actions support 6 fields?",
        "answer": "No, GitHub Actions workflows use standard 5-field cron syntax."
      },
      {
        "question": "How do I visualize standard cron?",
        "answer": "Use our Cron Visualizer to generate human-readable schedules from any 5-field expression."
      }
    ]
  },
  "property-does-not-exist-on-type": {
    ...
    "faq": [
      {
        "question": "Can I use \"any\" to bypass this?",
        "answer": "Using `any` defeats the purpose of TypeScript. It's better to define the correct type."
      },
      {
        "question": "How do I generate accurate interfaces?",
        "answer": "Paste your API JSON into our JSON to TS converter to instantly generate complete, nested interfaces."
      }
    ]
  },
  "expected-corresponding-jsx-closing-tag": {
    ...
    "faq": [
      {
        "question": "Why is JSX stricter than HTML?",
        "answer": "JSX compiles down to JavaScript function calls (React.createElement). It needs strict XML-like syntax to parse correctly."
      },
      {
        "question": "Can I automate this cleanup?",
        "answer": "Yes, our SVG to JSX tool automatically closes tags, converts attributes to camelCase, and formats the code for React."
      }
    ]
  },
  "hmac-key-must-be-buffer": {
    ...
    "faq": [
      {
        "question": "Can the key be a string?",
        "answer": "Yes, Node.js accepts strings or Buffers for the key. The error specifically occurs when you pass undefined."
      },
      {
        "question": "How do I test webhook signatures?",
        "answer": "Use our HMAC Generator to manually hash payloads using your secret key."
      }
    ]
  },
  "self-signed-certificate-in-chain": {
    ...
    "faq": [
      {
        "question": "Why does curl work but Node fails?",
        "answer": "Your OS or curl might have the corporate CA installed in their trust store. Node.js uses its own hardcoded Mozilla trust store."
      },
      {
        "question": "How do I inspect the self-signed cert?",
        "answer": "Use our Certificate Decoder to inspect the issuer and confirm it's your corporate proxy."
      }
    ]
  }
};

export const RECIPE_SLUGS = Object.keys(RECIPE_REGISTRY);

export function getRecipeMeta(slug: string): RecipeMeta | undefined {
  return RECIPE_REGISTRY[slug];
}
