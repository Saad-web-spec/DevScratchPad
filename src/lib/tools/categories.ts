...
export const CATEGORIES_REGISTRY: Record<string, CategoryMeta> = {
  formatters: {
    ...
    seoTitle: "Offline Formatters & Validators",
  ...
  converters: {
    ...
    seoTitle: "Offline Code & Type Converters",
  ...
  crypto: {
    ...
    seoTitle: "Security & Cryptography Tools",
  ...
  generators: {
    ...
    seoTitle: "Data Generators & Mock Tools",
  ...
  utilities: {
    ...
    seoTitle: "Time & Network Developer Tools",
