...
export const CATEGORIES_REGISTRY: Record<string, CategoryMeta> = {
  ...
  converters: {
    ...
    seoTitle: "Code & Type Converters Online — JSON to TS, Zod, Go & cURL",
  ...
  crypto: {
    ...
    seoTitle: "Security & Cryptography Tools Online — JWT, Hashes, Bcrypt & SSH Keys",
  ...
  generators: {
    ...
    seoTitle: "Data Generators & Mocks Online — Bulk UUID, ULID & Mock Data",
  ...
  utilities: {
    ...
    seoTitle: "Time, Network & Developer Utilities Online — Epoch, Regex, Diff, Cron & CIDR",
