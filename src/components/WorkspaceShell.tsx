...
const Base64DecoderTool = dynamic(() => import("@/components/tools/Base64DecoderTool").then(mod => mod.Base64DecoderTool), { ssr: false });
const UrlEncoderTool = dynamic(() => import("@/components/tools/UrlEncoderTool").then(mod => mod.UrlEncoderTool), { ssr: false });
...
const MarkdownPreviewerTool = dynamic(() => import("@/components/tools/MarkdownPreviewerTool").then(mod => mod.MarkdownPreviewerTool), { ssr: false });
