...
export function SeoContent({ tool }: { tool: ToolMeta }) {
  ...
  return (
    <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-[#27272A] max-w-4xl pb-24 mx-auto px-4 w-full">
      ...
      <ol className="list-decimal pl-5 space-y-2.5 text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed mb-8">
      ...
      {tool.edgeCases.length > 0 && (
        <>
          <h3 className="mt-8 mb-3 text-lg font-semibold text-zinc-800 dark:text-zinc-200">
            Edge Cases &amp; Important Considerations
          </h3>
          <ul className="list-disc pl-5 space-y-2 text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed mb-8">
      ...
      <h3 className="mt-8 mb-4 text-lg font-semibold text-zinc-800 dark:text-zinc-200 flex items-center gap-2">
      ...
      {relatedTools.length > 0 && (
        <div className="mt-10 pt-6 border-t border-zinc-200 dark:border-[#27272A]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {relatedTools.map((rel) => (
              ...
              >
                <div>
                  <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100 group-hover:text-blue-500 transition-colors">
                    {rel.name}
                  </p>
