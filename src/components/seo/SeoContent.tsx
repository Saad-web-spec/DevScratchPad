...
export function SeoContent({ tool }: { tool: ToolMeta }) {
  ...
  return (
    <section className="border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 px-6 py-8 max-w-4xl">
      <script
      ...
      <div className="mt-6 flex items-start gap-3 p-4 bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 dark:border-emerald-800 rounded-lg">
