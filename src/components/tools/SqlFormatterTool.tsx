...
export function SqlFormatterTool({
 ...
 className="h-8 px-3 text-xs font-semibold rounded-md shadow-none transition-colors flex items-center gap-1.5 bg-zinc-900 hover:bg-zinc-800 text-white shrink-0"
 >
