...
export function JsonFormatterTool({ onValidationChange, onStatsChange, onLogHistory, restoredInput }: JsonFormatterToolProps) {
 ...
 <h2 className="text-sm font-semibold text-zinc-800">JSON Formatter & Validator</h2>
 </div>
 ...
 <button onClick={handleMinify} className="h-9 px-3 bg-white hover:bg-[#27272A] border border-zinc-200 text-zinc-300 text-xs font-medium rounded-md transition-colors flex items-center gap-1.5 shrink-0">
