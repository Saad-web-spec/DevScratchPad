...
export function TimestampConverterTool({ onValidationChange, onStatsChange, restoredInput }: TimestampConverterToolProps) {
 ...
 <h1 className="text-sm font-semibold text-zinc-800">Unix Timestamp Converter</h1>
 </div>
 ...
 {/* Input Section */}
 <div className="flex items-center bg-zinc-50 border border-zinc-200 rounded-lg p-1.5 px-3 md:px-4 gap-2 md:gap-3 focus-within:ring-1 focus-within:ring-zinc-400">
