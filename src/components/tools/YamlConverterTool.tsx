  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-slate-950 w-full overflow-x-hidden">
      ...
      <div className="min-h-14 border-b border-[#e2e8f0] dark:border-slate-700 flex flex-wrap md:flex-nowrap items-center justify-between px-3 md:px-4 py-2 md:py-0 bg-[#f8fafc] dark:bg-slate-900 shrink-0 gap-2">
        <div>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-slate-200">YAML / JSON Converter</h2>
          <p className="text-[11px] text-slate-400 dark:text-slate-500 hidden sm:block">Convert YAML to JSON and JSON to YAML bidirectionally</p>
        </div>
        ...
        <div className="flex items-center gap-1.5 md:gap-3 flex-wrap">
          ...
          {mode === "yaml-to-json" && (
            <select
              ...
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 text-xs rounded px-2 py-1.5 focus:outline-none focus:border-blue-500"
            >
