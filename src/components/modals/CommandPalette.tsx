  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-2xl shadow-zinc-200/60 dark:shadow-2xl dark:shadow-black/40 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-150">
        <div className="flex items-center px-4 border-b border-zinc-200 dark:border-zinc-800">
          ...
          <input
            ...
            className="flex-1 bg-transparent border-none text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 h-14 px-4 focus:outline-none focus:ring-0 text-base sm:text-lg"
          />
          <kbd className="hidden sm:inline-block px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-[10px] font-medium text-zinc-400">
            ESC
          </kbd>
        </div>
                ...
                <li key={tool.id}>
                  <button
                    ...
                    className={cn(
                      ...
                      selectedIndex === index
                        ? "bg-blue-50 dark:bg-zinc-800 text-blue-600 dark:text-zinc-50 font-medium"
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        "text-xs font-mono",
                        selectedIndex === index
                          ? "text-blue-500 dark:text-zinc-400"
                          : "text-zinc-400 dark:text-zinc-500"
                      )}
                    >
                      {tool.category}
